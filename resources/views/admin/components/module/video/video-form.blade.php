                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" name="description" class="form-control"
                                        placeholder="Enter description" value="{{ $video->description }}">
                                </div>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select required class="form-control " name="status">
                                        ...
                                        <option {{ $video->status == 'active' ? 'selected' : '' }} value="active">Active
                                        </option>
                                ...
                                <div class="col-6">
                                    <button class="btn btn-dark"><a style="color: white;" href="{{ route('get.videos') }}">
                                            Back </a></button>
                                </div>
                                <div class="col-6">
