                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select required class="form-control " name="status">
                                ...
                                <option {{ $video->status == 'inactive' ? 'selected' : '' }} value="inactive">In Active
                                </option>
                        ...
                        <div class="form-group col-4">
                            ...
                            <select class="select2" multiple="multiple" data-placeholder="Select a Category"
                                data-dropdown-css-class="select2-purple" name="category_id[]" style="width: 100%;">
                                @foreach ($categories as $obj)
                                    <option
                                        {{ in_array($obj->id, $video->categories->pluck('id')->toArray()) ? 'selected' : '' }}
                        ...
                        <div class="col-6">
                            <button class="btn btn-dark"><a style="color: white;" href="{{ route('get.videos') }}"> Back
                                </a></button>
                        </div>
                        <div class="col-6">
